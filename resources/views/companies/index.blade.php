...
@section('title', 'Company App | All Companies')
@section('content')
                    ...
                    @if($companies->count())
                      ...
                      <tr>
                        ...
                        <td width="150">
                          ...
                          <a href="{{ route('companies.destroy', $company->id) }}" class="btn-deleted btn btn-sm btn-circle btn-outline-danger" title="Delete"><i class="fa fa-times"></i></a>
                        </td>
                      </tr>
