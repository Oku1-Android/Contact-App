                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class = "form-group row">
                        <label for = "company_id" class="col-md-3 col-form-label">First Name</label>
                        <div class="col-md-9">
                 ...
                 <div class="col-md-12">
                    <div class = "form-group row">
                            <label for = "company_id" class="col-md-3 col-form-label">Phone Number</label>
                            <div class="col-md-9">
                 ...
                 <div class="form-group row mb-0">
                    <div class="col-md-9 offset-md-3">
                       ...
                       <a href="{{route('contacts.index',$contact->id ) }}" class="btn btn-outline-secondary">Cancel</a>
                       </div>
