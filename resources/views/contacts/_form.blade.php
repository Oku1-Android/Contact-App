<div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9">
          <textarea name="address" value="{{ old('address',$contact->address)}},$contact-> address" id="address" rows="3" class="form-control @error('address') is-invalid @enderror "></textarea>
